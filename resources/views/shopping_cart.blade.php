                ...
                <tbody>
                    ...
                    <tr class="cart_item">
                        <td class="product-name">
                            <div class="media">
                                <img class="pull-left" src="/source/image/product/{{$product['item']->image}}" width="" height="80" alt="">
                        ...
                        <td class="product-price">
                            <span class="amount"><span>{{$product['item']->promotion_price !=0?number_format($product['item']->promotion_price,0):
                        ...
                        <td class="product-quantity">
                            <select name="product-qty" id="product-qty">
                                <option value="1">{{$product['qty']}}</option>
                        ...
                        <td class="product-subtotal">
                            <span class="amount">{{$product['item']->promotion_price !=0?number_format($product['item']->promotion_price*$product['qty'],0):
                                number_format($product['item']->unit_price*$product['qty'],0)}}</span>
                        </td>
